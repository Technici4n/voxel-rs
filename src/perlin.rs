...
pub fn perlin(
    ...
    for _i in 0..octave {
        let noise = value_noise((x,y,z), (size, size, size), (factor_x, factor_y, factor_z), seed);
...
pub fn value_noise((x,y,z) : (f32,f32,f32),
                    (size_x, size_y, size_z) : (usize, usize, usize),
                    (scale_x, scale_y, scale_z) : (f32,f32,f32), seed : i32) -> Vec<f32>{
